...
public class HomePage {
    ...
    // Action Method
    public void checkHomeAloneTrailer() {
        // Enter product name
        driver.findElement(By.id(searchBoxLocator)).sendKeys("home alone");
        // click on searchButton
        driver.findElement(By.id(searchButtonLocator)).click();
    }
    ...
    public void checkBook() {
        // Enter product name
        driver.findElement(By.id(searchBoxLocator)).sendKeys("harry potter");
        // click on searchButton
        driver.findElement(By.id(searchButtonLocator)).click();
    ...
    public void checkChess() {
        // Enter product name
        driver.findElement(By.id(searchBoxLocator)).sendKeys("chess");
        // click on searchButton
        driver.findElement(By.id(searchButtonLocator)).click();

}
    public void checkNightLamp() {
        // Enter product name
        driver.findElement(By.id(searchBoxLocator)).sendKeys("night lamp");
        // click on searchButton
        driver.findElement(By.id(searchButtonLocator)).click();
    }
